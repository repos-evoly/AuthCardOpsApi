...
namespace AuthCardOpsApi.Data.Context
{
    public class AuthCardOpsApiDbContext : DbContext
    {
        public AuthCardOpsApiDbContext(DbContextOptions<AuthCardOpsApiDbContext> options) : base(options) { }
        public AuthCardOpsApiDbContext() { }
