...
using AuthCardOpsApi.Abstractions;
using AuthCardOpsApi.Core.Abstractions;

namespace AuthCardOpsApi.Endpoints
{
    public class AuthEndpoints : IEndpoints
    {
        ...
        public static async Task<IResult> Register(AuthCardOpsApiDbContext db, RegisterDto registerDto)
        {
        ...
        public static async Task<IResult> Login(AuthCardOpsApiDbContext db, IConfiguration config, HttpContext httpContext, LoginDto loginDto)
        {
            ...
            var accessToken = GenerateJwtTokenForAuthCardOpsApi(user, config);
        ...
        public static async Task<IResult> ForgotPassword(AuthCardOpsApiDbContext db, ForgotPasswordDto dto)
        {
            ...
            user.UserSecurity.PasswordResetTokenExpiry = DateTime.Now.AddMinutes(12000);
        ...
        public static async Task<IResult> ResetPassword(AuthCardOpsApiDbContext db, ResetPasswordDto dto)
        {
            var user = await db.Users.Include(u => u.UserSecurity)
        ...
        public static async Task<IResult> Logout(AuthCardOpsApiDbContext db, HttpContext httpContext)
        {
        ...
        private static string GenerateJwtTokenForAuthCardOpsApi(User user, IConfiguration config)
        {
            var jwtSection = config.GetSection("Jwt");
        ...
        public static async Task<IResult> RefreshToken(AuthCardOpsApiDbContext db, IConfiguration config, HttpContext httpContext)
        {
            ...
            var newAccessToken = GenerateJwtTokenForAuthCardOpsApi(user, config);
        ...
        public static async Task<IResult> GetRecaptchaSettings(AuthCardOpsApiDbContext db)
        {
            var settings = await db.Settings.FirstOrDefaultAsync();
